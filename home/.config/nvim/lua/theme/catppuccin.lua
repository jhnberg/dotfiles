...
local function derive_catppuccin_scheme(colours)
    return {
        general = {
            ...
            search_inactive = { fg = colours.surface0, bg = colours.teal },
            search_active   = { fg = colours.surface0, bg = colours.teal },
        },
        border = {
            inactive = { fg = colours.overlay0 },
        },
        popup = {
            deselected = { bg = colours.mantel },
            selectecd  = { fg = colours.rosewater, bg = colours.overlay2 },
        },
        message = {
        ...
        spell = {
            bad      = { fg = colours.red, undercurl = true },
            cap      = { fg = colours.yellow, undercurl = true },
            rare     = { fg = colours.mauve, undercurl = true },
            regional = { fg = colours.teal, undercurl = true },
        },
        syntax = {

...
local function derive_catppuccin_scheme(colours)
    return {
        ...
        spell_bad       = { fg = colours.red, undercurl = true },
        spell_cap       = { fg = colours.yellow, undercurl = true },
        spell_rare      = { fg = colours.mauve, undercurl = true },
        spell_local     = { fg = colours.teal, undercurl = true },
